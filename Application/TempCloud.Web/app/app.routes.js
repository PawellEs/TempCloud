    ...
    function ($stateProvider, $urlRouterProvider, $$ocLazyLoadProvider, ASSETS) {
        ...
        .state("app.dashboard", {
            ...
            .state("app.create-user", {
                url: "/create-user",
                templateUrl: appHelper.componentView('forms', 'create-user'),
                resolve: {
                    resources: function ($ocLazyLoad) {
                        return $ocLazyLoad.load([
            ...
            .state("app.edit-device", {
                url: "/edit-device",
                templateUrl: appHelper.componentView('forms', 'edit-device'),
                resolve: {
                    resources: function ($ocLazyLoad) {
                        return $ocLazyLoad.load([
                          ASSETS.css('forms', 'prettify'),
            ...
            .state("app.create-device", {
                url: "/create-device",
                templateUrl: appHelper.componentView('forms', 'create-device'),
                resolve: {
                    resources: function ($ocLazyLoad) {
                        return $ocLazyLoad.load([
                          ASSETS.css('forms', 'prettify'),
           ...
           .state("app.edit-user", {
               url: "/edit-user",
               templateUrl: appHelper.componentView('forms', 'edit-user'),
               resolve: {
                   resources: function ($ocLazyLoad) {
                       return $ocLazyLoad.load([
                         ASSETS.css('forms', 'prettify'),
          ...
          .state("app.settings", {
              url: "/settings",
              templateUrl: appHelper.componentView('forms', 'settings'),
              resolve: {
                  resources: function ($ocLazyLoad) {
                      return $ocLazyLoad.load([
                        ASSETS.css('forms', 'prettify'),
        ...
        .state("app.devices-table", {
            url: "/devices-table",
            templateUrl: appHelper.componentView('tables', 'devices-table'),
            resolve: {
                resources: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                      ASSETS.js('tables', 'jquery.dataTables.min'),
        ...
        .state("signin", {
            url: "/signin",
            templateUrl: appHelper.componentView('utility', 'signin'),
            resolve: {
                resources: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                     ASSETS.css('utility', 'signin'),
